"""
Django settings for round_limit_41494 project.
...
ROOT_URLCONF = 'round_limit_41494.urls'
...
WSGI_APPLICATION = 'round_limit_41494.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "round_limit_41494 API",
    "DESCRIPTION": "API documentation for round_limit_41494 App",
    "VERSION": "v1",
}
